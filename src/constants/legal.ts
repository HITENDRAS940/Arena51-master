export const PRIVACY_POLICY = `This privacy policy applies to the HYPER app and relevant infrastructure (hereby referred to as "Application") for mobile devices that was created by Hitendra Singh Shaktawat and Manan Arora (hereby referred to as "Service Provider") as a Commercial service. This service is intended for use "AS IS".
...
The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. You can delete your account and all associated data directly within the Application's Profile settings. Alternatively, if you'd like them to delete User Provided Data that you have provided via the Application, please contact them at manan.arora0412@gmail.com and they will respond in a reasonable time.
...
export const TERMS_OF_SERVICE = `Terms of Service content for HYPER app...
[Specific terms of service content should be added here]`;

export const ABOUT_APP = `Hyper is your premium gateway to discovering and booking the best sports venues and leisure activities in your city.

Our Mission
To make every game, every event, and every moment accessible and easy to book with just a few taps.`;